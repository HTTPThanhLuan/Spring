...
//                .withUser("admin").password("{noop}password").roles("ADMIN");
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                .antMatchers("/", "/login", "/registration","/employee/**", "/h2-console/**").permitAll()
                ...
                .and().rememberMe().rememberMeParameter("remember-me").tokenRepository(tokenRepository()) //remmber me by token base
        ;
